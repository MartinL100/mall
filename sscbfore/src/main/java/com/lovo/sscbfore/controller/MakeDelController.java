...
public class MakeDelController {
    ...
    public String initDel(){
        ...
        goodsDTO.setGoodsName("牙刷");
        goodsDTO.setGoodsNorms("大号");
        goodsDTO.setGoodsNum(85l);
        goodsDTO.setGoodsPrice(5f);
        goodsDTO.setGoodsType("生活用品");
...
//        errorInfo=  restTemplate.postForEntity(UrlUtil.CHECK_ORDER_URL,orderInfo,String.class).getBody();
        ...
        //审核未成功，返回错误信息
        if(!StringUtils.isEmpty(errorInfoMap.get("errorInfo"))){
