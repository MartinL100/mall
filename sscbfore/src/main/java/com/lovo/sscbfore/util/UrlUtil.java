...
public class UrlUtil {
    ...
    public static final String UPDATE_GOODS_NUM_URL="http://sscafter/updateGoodsNumL";
   ...
   /** {page}/{rows}/{goodsType}/{goodsName}*/
    public static final String FIND_ALL_GOODS="http://sscafter/promotion/findPromotin/";
}
