...
public interface FindinderDao {
    ...
    public List<IndentEntity>  findIner(String supplierId,String indentId ,String indentStatus,String startDate,String endDate,int pageNumber, int pageSize);

    public long CountIner(String supplierId,String indentId ,String indentStatus,String startDate,String endDate);
}
