...
String hql="select new com.lovo.sscafter.goodsStock.dto.ReturnGoodsDto(re.returnGoodsId as returnGoodsId," +
        "re.returnGoodsDate as returnGoodsDate,oe.supplierId as supplierId,ge.goodsName as goodsName," +
        " ge.goodsId as goodsId,ge.goodsType as goodsType,ge.goodsNorms as goodsNorms," +
        "  ge.goodsUnit as goodsUnit,re.returnGoodsCause as returnGoodsCause,oe.goodsNum as returnGoodsNum,oe.goodsBid as goodsBid) from GoodsStockEntity ge left " +
        " join ReturnGoodsEntity re on ge.goodsId=re.goods.goodsId left join OrderGoodsEntity oe " +
        " on oe.goods.goodsId=ge.goodsId";
